...
//        [[NSAlert alertWithMessageText:@"Apple80211Scan failed"
//                         defaultButton:nil
//                       alternateButton:nil
//                           otherButton:nil
//             informativeTextWithFormat:@"%i, %s", error, Apple80211ErrToStr(error)] runModal];
        return FALSE;
    }
...
//    
//    network = CFDictionaryCreateMutable(kCFAllocatorDefault,
//                                        1,
//                                        &kCFTypeDictionaryKeyCallBacks,
//                                        &kCFTypeDictionaryValueCallBacks);
//    
...
//        buffer = CFArrayGetValueAtIndex(scan, i);
//        CFDictionarySetValue(network, CFSTR("SSID"), CFDictionaryGetValue(buffer, @"SSID_STR"));
//        CFDictionarySetValue(network, CFSTR("RSSI"), CFDictionaryGetValue(buffer, @"RSSI"));
//        CFDictionarySetValue(network, CFSTR("NOISE"), CFDictionaryGetValue(buffer, @"NOISE"));
//        CFDictionarySetValue(network, CFSTR("BSSID"), CFDictionaryGetValue(buffer, @"BSSID"));
//        CFDictionarySetValue(network, CFSTR("CHANNEL"), CFDictionaryGetValue(buffer, @"CHANNEL"));
//        CFDictionarySetValue(network, CFSTR("AP_MODE"), CFDictionaryGetValue(buffer, @"AP_MODE"));
//        
//        if (CFDictionaryContainsKey(buffer, @"WPA_IE")) {
//            CFDictionarySetValue(network, CFSTR("SECURITY"), CFSTR("WPA"));
//        } else if (CFDictionaryContainsKey(buffer, @"WEP")) {
//            CFDictionarySetValue(network, CFSTR("SECURITY"), CFSTR("WEP"));
//        } else if (CFDictionaryContainsKey(buffer, @"RSN_IE")){
//            CFDictionarySetValue(network, CFSTR("SECURITY"), CFSTR("WPA2"));
//            
//        } else {
//            
//            CFDictionarySetValue(network, CFSTR("SECURITY"), CFSTR("Open"));
//        }
//        
//        //CFArraySetValueAtIndex(result, i, CFDictionaryCreateCopy(kCFAllocatorDefault, network));
//
//        
//        //[array addObject:(__bridge id)CFDictionaryCreateCopy(kCFAllocatorDefault, network)];
//        
//    }
    ...
    for (NSDictionary *a in nsscan)
    {
        ...
        if (a[@"WPA_IE"]) {
            ...
            [dict setValue:@"Open" forKey:@"SECURTY"];
        }
